...
public abstract class Joueur {
    ...
    protected int scoreTotal;      // score cumulé sur toutes les parties
    protected int nbFleursTotal;   // nombre total de fleurs cueillies
    protected int scoreSession;    // score de la partie en cours
    protected int nbFleursSession; // fleurs cueillies dans la partie en cours
